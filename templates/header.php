    ...
    <div class="container-fluid">
        <nav class="navbar navbar-toggleable-md navbar-light">
            ...
            <a class="navbar-brand" href="<?= esc_url(home_url('/')); ?>">
                <img src="<?php bloginfo('url') ?>/wp-content/uploads/2017/06/bonitabasics.svg" title="Bonita Basics | San Diego Hip Hop Producer" alt="Bonita Basics San Diego Hip Hop Producer" width="120" height="20" />
            </a>
